...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SpectrogramPlot_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 45, 5)
    ...
    "SpectrogramPlot\0showSpectrogram\0\0on\0"
    "setAlpha\0alpha"
};
...
void SpectrogramPlot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->showSpectrogram((*reinterpret_cast< bool(*)>(_a[1]))); break;
...
const QMetaObject SpectrogramPlot::staticMetaObject = {
    { &QwtPlot::staticMetaObject, qt_meta_stringdata_SpectrogramPlot.data,
      qt_meta_data_SpectrogramPlot,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SpectrogramPlot.stringdata))
        return static_cast<void*>(const_cast< SpectrogramPlot*>(this));
