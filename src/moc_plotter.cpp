...
QT_MOC_LITERAL(4, 27, 5)
    ...
    "Plotter\0readyForPlot\0\0done\0start"
};
...
void Plotter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Plotter::readyForPlot)) {
                *result = 0;
            }
        }
        {
            typedef void (Plotter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Plotter::done)) {
                *result = 1;
            }
        }
    }
